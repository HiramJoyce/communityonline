...
<% if(request.getSession().getAttribute("role") == null || !request.getSession().getAttribute("role").equals("waiter")) response.sendRedirect("/waiter/login"); %>
...
<nav class="navbar navbar-inverse" style="border-radius: 0; margin-bottom: 0; position: relative;">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/">社区服务系统</a>
        </div>
    ...
    <div style="width: 150px; background: #718093; float: left; height: 100%; margin-top: -50px; padding-top: 50px;">
        <div style="margin: auto; text-align: center;">
            <button class="btn btn-link" style="color: #FFFFFF;" href="javascript:" onclick="formSubmit('${ctx}/servicesPage1','mframe');this.blur();">服务管理</button>
        </div>
    </div>
    <div style="margin-left: 150px; height: 100%; margin-top: -50px; padding-top: 50px;">
        <iframe name="mframe" id="mframe" width="100%" src="${ctx}/servicesPage1" style="height: 100%;" frameborder="0"></iframe>
    </div>
