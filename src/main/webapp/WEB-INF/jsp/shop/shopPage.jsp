...
<% if(request.getSession().getAttribute("role") == null || !request.getSession().getAttribute("role").equals("shop")) response.sendRedirect("/shop/login"); %>
...
<nav class="navbar navbar-inverse" style="border-radius: 0; margin-bottom: 0; position: relative;">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/">社区便利店系统</a>
        </div>
    ...
    <div style="width: 150px; background: #718093; float: left; height: 100%; margin-top: -50px; padding-top: 50px;">
        <div style="margin: auto; text-align: center;">
            ...
            <button class="btn btn-link" style="color: #FFFFFF;" href="javascript:" onclick="formSubmit('${ctx}/servicesPage1','mframe');this.blur();">商品管理</button>
        </div>
    </div>
